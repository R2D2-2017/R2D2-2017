/**
 * \file
 * \brief     this file constains a class for detecting gestures like mouse movements.
...
public:
    ...
    */
    ...
    /**
     *\brief this function detect how far the mouse has moved in the given update inteval. This function is used for dragging a window using the mouse.
