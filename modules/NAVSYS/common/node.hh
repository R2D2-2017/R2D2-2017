...
public:
    ...
    /**
     * \brief Gets the coordinate of a node.
     *
    ...
    /**
     * \brief Gets node from sf::Packet.
     *
...
/**
 * \brief Puts node vector in sf::Packet.
 *
