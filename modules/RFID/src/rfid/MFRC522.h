...
public:
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    MFRC522(SPIClass *spiClass = &SPI, const SPISettings spiSettings = SPISettings(10000000, MSBFIRST, 0))
    ...
    static const std::string GetStatusCodeName(StatusCode code);
    static const std::string PICC_GetTypeName(PICC_Type type);
...
protected:
    ...
    byte
        _resetPowerDownPin;    // Arduino pin connected to MFRC522's reset and power down input (Pin 6, NRSTPD, active low)
